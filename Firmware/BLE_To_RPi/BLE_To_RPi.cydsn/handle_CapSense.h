...
/* Include guard */
#ifndef HANDLE_CAPSENSE_H
#define HANDLE_CAPSENSE_H
...
/* Functions that scan CapSense sensors, process touch information and then
   call separate routines to send the processed data as BLE notifications */
