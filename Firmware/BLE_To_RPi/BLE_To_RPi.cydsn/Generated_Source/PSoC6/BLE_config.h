...
#define CY_BLE_CAPSENSE_SLIDER_SERVICE_INDEX   (0x00u) /* Index of CapSense Slider service in the cy_ble_customs array */
#define CY_BLE_CAPSENSE_SLIDER_CAPSENSE_SLIDER_CHAR_INDEX   (0x00u) /* Index of CapSense Slider characteristic */
#define CY_BLE_CAPSENSE_SLIDER_CAPSENSE_SLIDER_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_CAPSENSE_SLIDER_CAPSENSE_SLIDER_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_RGB_LED_SERVICE_INDEX   (0x01u) /* Index of RGB LED service in the cy_ble_customs array */
#define CY_BLE_RGB_LED_RGB_LED_CONTROL_CHAR_INDEX   (0x00u) /* Index of RGB LED Control characteristic */
#define CY_BLE_RGB_LED_RGB_LED_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_RGB_LED_RGB_LED_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_CAPSENSE_BUTTON_SERVICE_INDEX   (0x02u) /* Index of CapSense Button service in the cy_ble_customs array */
#define CY_BLE_CAPSENSE_BUTTON_CAPSENSE_BUTTON_CHAR_INDEX   (0x00u) /* Index of CapSense Button characteristic */
#define CY_BLE_CAPSENSE_BUTTON_CAPSENSE_BUTTON_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_CAPSENSE_BUTTON_CAPSENSE_BUTTON_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */


#define CY_BLE_CAPSENSE_SLIDER_SERVICE_HANDLE   (0x0010u) /* Handle of CapSense Slider service */
#define CY_BLE_CAPSENSE_SLIDER_CAPSENSE_SLIDER_DECL_HANDLE   (0x0011u) /* Handle of CapSense Slider characteristic declaration */
#define CY_BLE_CAPSENSE_SLIDER_CAPSENSE_SLIDER_CHAR_HANDLE   (0x0012u) /* Handle of CapSense Slider characteristic */
#define CY_BLE_CAPSENSE_SLIDER_CAPSENSE_SLIDER_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0013u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_CAPSENSE_SLIDER_CAPSENSE_SLIDER_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0014u) /* Handle of Characteristic User Description descriptor */

#define CY_BLE_RGB_LED_SERVICE_HANDLE   (0x0015u) /* Handle of RGB LED service */
#define CY_BLE_RGB_LED_RGB_LED_CONTROL_DECL_HANDLE   (0x0016u) /* Handle of RGB LED Control characteristic declaration */
#define CY_BLE_RGB_LED_RGB_LED_CONTROL_CHAR_HANDLE   (0x0017u) /* Handle of RGB LED Control characteristic */
#define CY_BLE_RGB_LED_RGB_LED_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0018u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_RGB_LED_RGB_LED_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0019u) /* Handle of Characteristic User Description descriptor */

#define CY_BLE_CAPSENSE_BUTTON_SERVICE_HANDLE   (0x001Au) /* Handle of CapSense Button service */
#define CY_BLE_CAPSENSE_BUTTON_CAPSENSE_BUTTON_DECL_HANDLE   (0x001Bu) /* Handle of CapSense Button characteristic declaration */
#define CY_BLE_CAPSENSE_BUTTON_CAPSENSE_BUTTON_CHAR_HANDLE   (0x001Cu) /* Handle of CapSense Button characteristic */
#define CY_BLE_CAPSENSE_BUTTON_CAPSENSE_BUTTON_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x001Du) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_CAPSENSE_BUTTON_CAPSENSE_BUTTON_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x001Eu) /* Handle of Characteristic User Description descriptor */
