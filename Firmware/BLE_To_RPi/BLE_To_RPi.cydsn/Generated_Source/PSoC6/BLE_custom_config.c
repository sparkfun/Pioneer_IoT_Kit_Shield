...
static const cy_stc_ble_customs_t cy_ble_customs[0x03u] = {
    ...
    /* CapSense Slider service */
    {
        0x0010u, /* Handle of the CapSense Slider service */ 
        {

            /* CapSense Slider characteristic */
            {
                0x0012u, /* Handle of the CapSense Slider characteristic */ 
    ...
    /* RGB LED service */
    {
        0x0015u, /* Handle of the RGB LED service */ 
        {

            /* RGB LED Control characteristic */
            {
                0x0017u, /* Handle of the RGB LED Control characteristic */ 
    ...
    /* CapSense Button service */
    {
        0x001Au, /* Handle of the CapSense Button service */ 
        {

            /* CapSense Button characteristic */
            {
                0x001Cu, /* Handle of the CapSense Button characteristic */ 
