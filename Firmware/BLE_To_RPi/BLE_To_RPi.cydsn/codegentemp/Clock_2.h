...
{
    Cy_SysClk_PeriphEnableDivider(Clock_2_DIV_TYPE, Clock_2_DIV_NUM);
}
...
{
    Cy_SysClk_PeriphDisableDivider(Clock_2_DIV_TYPE, Clock_2_DIV_NUM);
}
...
{
    Cy_SysClk_PeriphSetDivider(Clock_2_DIV_TYPE, Clock_2_DIV_NUM, dividerValue);
}
...
{
    Cy_SysClk_PeriphSetFracDivider(Clock_2_DIV_TYPE, Clock_2_DIV_NUM, dividerIntValue, dividerFracValue);
}
