...
const CYBLE_CUSTOMS_T cyBle_customs[0x06u] = {
    ...
    /* BME280_Temp service */
    {
        0x000Cu, /* Handle of the BME280_Temp service */ 
        {

            /* BME280_Temp characteristic */
            {
                0x000Eu, /* Handle of the BME280_Temp characteristic */ 
    ...
    /* BME280_Pressure service */
    {
        0x0011u, /* Handle of the BME280_Pressure service */ 
        {

            /* BME280_Pressure characteristic */
            {
                0x0013u, /* Handle of the BME280_Pressure characteristic */ 
    ...
    {
        0x0016u, /* Handle of the BME280_Humidity service */ 
        {

            /* BME280_Humidity characteristic */
            {
                0x0018u, /* Handle of the BME280_Humidity characteristic */ 
    ...
    /* CCS811_TVOC service */
    {
        0x001Bu, /* Handle of the CCS811_TVOC service */ 
        {

            /* CCS811_TVOC characteristic */
            {
                0x001Du, /* Handle of the CCS811_TVOC characteristic */ 
    ...
    /* CCS811_ECO2 service */
    {
        0x0020u, /* Handle of the CCS811_ECO2 service */ 
        {

            /* CCS811_ECO2 characteristic */
            {
                0x0022u, /* Handle of the CCS811_ECO2 characteristic */ 
    ...
    /* EnvSensors service */
    {
        0x0025u, /* Handle of the EnvSensors service */ 
        {

            /* Custom Characteristic characteristic */
            {
                0x0027u, /* Handle of the Custom Characteristic characteristic */ 
