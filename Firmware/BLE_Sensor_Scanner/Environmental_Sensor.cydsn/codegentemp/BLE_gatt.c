    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    (uint8)'B', (uint8)'M', (uint8)'E', (uint8)'2', (uint8)'8', (uint8)'0', (uint8)' ', (uint8)'T', (uint8)'e',
    ...
    /* Characteristic User Description */
    (uint8)'B', (uint8)'M', (uint8)'E', (uint8)'2', (uint8)'8', (uint8)'0', (uint8)' ', (uint8)'P', (uint8)'r',
    (uint8)'e', (uint8)'s', (uint8)'s', (uint8)'u', (uint8)'r', (uint8)'e',

    /* BME280_Humidity */
    0x00u,

    /* Characteristic User Description */
    (uint8)'B', (uint8)'M', (uint8)'E', (uint8)'2', (uint8)'8', (uint8)'0', (uint8)' ', (uint8)'H', (uint8)'u',
    (uint8)'m', (uint8)'i', (uint8)'d', (uint8)'i', (uint8)'t', (uint8)'y',

    /* CCS811_TVOC */
    0x00u,

    /* Characteristic User Description */
    (uint8)'C', (uint8)'C', (uint8)'S', (uint8)'8', (uint8)'1', (uint8)'1', (uint8)' ', (uint8)'T', (uint8)'V',
    (uint8)'O', (uint8)'C',
    ...
    /* Characteristic User Description */
    (uint8)'C', (uint8)'C', (uint8)'S', (uint8)'8', (uint8)'1', (uint8)'1', (uint8)' ', (uint8)'E', (uint8)'C',
    (uint8)'O', (uint8)'2',
    ...
    /* Characteristic User Description */
    (uint8)'A', (uint8)'l', (uint8)'l', (uint8)' ', (uint8)'t', (uint8)'h', (uint8)'e', (uint8)' ', (uint8)'s',
    (uint8)'e', (uint8)'n', (uint8)'s', (uint8)'o', (uint8)'r', (uint8)' ', (uint8)'d', (uint8)'a', (uint8)'t',
    (uint8)'a',
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0012u, (void *)&cyBle_attValues[26] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* BME280_Pressure UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[3] }, /* BME280_Pressure UUID */
    { 0x0001u, (void *)&cyBle_attValues[44] }, /* BME280_Pressure */
    ...
    { 0x0001u, (void *)&cyBle_attValues[60] }, /* BME280_Humidity */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[6] }, /* Client Characteristic Configuration */
    { 0x000Fu, (void *)&cyBle_attValues[61] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[6] }, /* CCS811_TVOC UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[7] }, /* CCS811_TVOC UUID */
    { 0x0001u, (void *)&cyBle_attValues[76] }, /* CCS811_TVOC */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[8] }, /* Client Characteristic Configuration */
    { 0x000Bu, (void *)&cyBle_attValues[77] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[8] }, /* CCS811_ECO2 UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[9] }, /* CCS811_ECO2 UUID */
    { 0x0001u, (void *)&cyBle_attValues[88] }, /* CCS811_ECO2 */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[10] }, /* Client Characteristic Configuration */
    { 0x000Bu, (void *)&cyBle_attValues[89] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[10] }, /* EnvSensors UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[11] }, /* Custom Characteristic UUID */
    { 0x000Au, (void *)&cyBle_attValues[100] }, /* Custom Characteristic */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[12] }, /* Client Characteristic Configuration */
    { 0x0013u, (void *)&cyBle_attValues[110] }, /* Characteristic User Description */
};

const CYBLE_GATTS_DB_T cyBle_gattDB[0x29u] = {
    ...
    { 0x000Cu, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x0010u, {{0x0010u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0010u, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Eu, 0x5002u /* BME280_Temp                         */, 0x09120001u /* rd,ntf */, 0x0010u, {{0x0002u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0010u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0010u, {{0x0012u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0011u, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x0015u, {{0x0010u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0012u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0015u, {{0x0010u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x0013u, 0x5012u /* BME280_Pressure                     */, 0x09120001u /* rd,ntf */, 0x0015u, {{0x0001u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x0014u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0014u, {{0x0002u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x0015u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0015u, {{0x000Fu, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0016u, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x001Au, {{0x0010u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0017u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x001Au, {{0x0010u, (void *)&cyBle_attValuesLen[16]}} },
    { 0x0018u, 0x5022u /* BME280_Humidity                     */, 0x09120001u /* rd,ntf */, 0x001Au, {{0x0001u, (void *)&cyBle_attValuesLen[17]}} },
    { 0x0019u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0019u, {{0x0002u, (void *)&cyBle_attValuesLen[18]}} },
    { 0x001Au, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x001Au, {{0x000Fu, (void *)&cyBle_attValuesLen[19]}} },
    { 0x001Bu, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x001Fu, {{0x0010u, (void *)&cyBle_attValuesLen[20]}} },
    { 0x001Cu, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x001Fu, {{0x0010u, (void *)&cyBle_attValuesLen[21]}} },
    { 0x001Du, 0x5032u /* CCS811_TVOC                         */, 0x09120001u /* rd,ntf */, 0x001Fu, {{0x0001u, (void *)&cyBle_attValuesLen[22]}} },
    { 0x001Eu, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x001Eu, {{0x0002u, (void *)&cyBle_attValuesLen[23]}} },
    { 0x001Fu, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x001Fu, {{0x000Bu, (void *)&cyBle_attValuesLen[24]}} },
    { 0x0020u, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x0024u, {{0x0010u, (void *)&cyBle_attValuesLen[25]}} },
    { 0x0021u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0024u, {{0x0010u, (void *)&cyBle_attValuesLen[26]}} },
    { 0x0022u, 0x5042u /* CCS811_ECO2                         */, 0x09120001u /* rd,ntf */, 0x0024u, {{0x0001u, (void *)&cyBle_attValuesLen[27]}} },
    { 0x0023u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0023u, {{0x0002u, (void *)&cyBle_attValuesLen[28]}} },
    { 0x0024u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0024u, {{0x000Bu, (void *)&cyBle_attValuesLen[29]}} },
    { 0x0025u, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x0029u, {{0x0010u, (void *)&cyBle_attValuesLen[30]}} },
    { 0x0026u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0029u, {{0x0010u, (void *)&cyBle_attValuesLen[31]}} },
    { 0x0027u, 0x5052u /* Custom Characteristic               */, 0x09120001u /* rd,ntf */, 0x0029u, {{0x000Au, (void *)&cyBle_attValuesLen[32]}} },
    { 0x0028u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0028u, {{0x0002u, (void *)&cyBle_attValuesLen[33]}} },
    { 0x0029u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0029u, {{0x0013u, (void *)&cyBle_attValuesLen[34]}} },
};
