// ======================================================================
// Environmental_Sensor.v generated from TopDesign.cysch
// 02/07/2018 at 09:53
...
module BLE_v3_40_1 (
	...
	cy_clock_v1_0
		#(.id("1dc0157d-2a4b-4c43-834f-c1c35d1097c3/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	wire [0:0] tmpOE__DISCON_LED_net;
	wire [0:0] tmpFB_0__DISCON_LED_net;
	wire [0:0] tmpIO_0__DISCON_LED_net;
	wire [0:0] tmpINTERRUPT_0__DISCON_LED_net;
	electrical [0:0] tmpSIOVREF__DISCON_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		DISCON_LED
		 (.oe(tmpOE__DISCON_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DISCON_LED_net[0:0]}),
		  .io({tmpIO_0__DISCON_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__DISCON_LED_net),
		  .interrupt({tmpINTERRUPT_0__DISCON_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DISCON_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("b65f1656-f53c-497d-ba04-ae25fa2f79a9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fcf2d367-229f-425b-a980-04dbc8ff8151"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
