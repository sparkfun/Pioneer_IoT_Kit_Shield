...
static cy_stc_ble_gapc_scan_params_t cy_ble_gapcScanConfig[0x01u] = {
    ...
    {
        .fastScanInterval                   = 0x0008u, 
        .fastScanWindow                     = 0x0008u, 
        .fastScanTimeOut                    = 0x0000u, 
        .slowScanEnabled                    = 0x00u, 
        .slowScanInterval                   = 0x0800u, 
        .slowScanWindow                     = 0x0708u, 
        .slowScanTimeOut                    = 0x0000u, 
        .gapcConnectionIntervalMin          = 0x0010u, 
...
static uint8_t cy_ble_attValues[0x59u] = {
    /* Device Name */
    (uint8_t)'E', (uint8_t)'n', (uint8_t)'v', (uint8_t)' ', (uint8_t)'S', (uint8_t)'e', (uint8_t)'n', (uint8_t)'s',
(uint8_t)'o', (uint8_t)'r', (uint8_t)' ', (uint8_t)'H', (uint8_t)'u', (uint8_t)'b', 
...
(uint8_t)'u', (uint8_t)'c', (uint8_t)'t', (uint8_t)'o', (uint8_t)'r', 
    ...
    /* Model Number String */
    (uint8_t)'B', (uint8_t)'A', (uint8_t)'S', (uint8_t)' ', (uint8_t)'v', (uint8_t)'1', (uint8_t)'.', (uint8_t)'0',
(uint8_t)' ', (uint8_t)'M', (uint8_t)'M', (uint8_t)'S', (uint8_t)'S', 
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x07u] = {
    ...
    { 0x0015u, (void *)&cy_ble_attValues[20] }, /* Manufacturer Name String */
    { 0x000Du, (void *)&cy_ble_attValues[41] }, /* Model Number String */
    { 0x0023u, (void *)&cy_ble_attValues[54] }, /* Hardware Revision String */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x10u] = {
    ...
    { 0x0007u, 0x2803u /* Characteristic                      */, 0x00200001u /* ind   */, 0x0009u, {{0x2A05u, NULL}}                           },
    { 0x0008u, 0x2A05u /* Service Changed                     */, 0x01200000u /* ind   */, 0x0009u, {{0x0004u, (void *)&cy_ble_attValuesLen[2]}} },
    { 0x0009u, 0x2902u /* Client Characteristic Configuration */, 0x030A0101u /* rd,wr */, 0x0009u, {{0x0002u, (void *)&cy_ble_attValuesLen[3]}} },
    { 0x000Au, 0x2800u /* Primary service                     */, 0x00000001u /*       */, 0x0010u, {{0x180Au, NULL}}                           },
    { 0x000Bu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x000Cu, {{0x2A29u, NULL}}                           },
    { 0x000Cu, 0x2A29u /* Manufacturer Name String            */, 0x01020001u /* rd    */, 0x000Cu, {{0x0015u, (void *)&cy_ble_attValuesLen[4]}} },
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x000Eu, {{0x2A24u, NULL}}                           },
    { 0x000Eu, 0x2A24u /* Model Number String                 */, 0x01020001u /* rd    */, 0x000Eu, {{0x000Du, (void *)&cy_ble_attValuesLen[5]}} },
    { 0x000Fu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0010u, {{0x2A27u, NULL}}                           },
    { 0x0010u, 0x2A27u /* Hardware Revision String            */, 0x01020001u /* rd    */, 0x0010u, {{0x0023u, (void *)&cy_ble_attValuesLen[6]}} },
};
...
cy_stc_ble_gap_bd_addr_t cy_ble_deviceAddress = {{0x00u, 0x02u, 0x00u, 0x50u, 0xA0u, 0x00u}, 0x00u };
