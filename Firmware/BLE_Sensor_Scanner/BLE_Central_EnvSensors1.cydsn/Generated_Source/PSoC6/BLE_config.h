...
#define CY_BLE_CONFIG_GATTC_COUNT                   (0x04u)
...
#define CY_BLE_CONFIG_GATT_DB_MAX_VALUE_LEN         (0x0023u)

#define CY_BLE_GATT_DB_INDEX_COUNT                  (0x0010u)
...
#define CY_BLE_CONFIG_CUSTOMC_SERVICE_COUNT         (0x06u)
...
#define CY_BLE_CUSTOMC_BME280_TEMP_SERVICE_INDEX   (0x00u) /* Index of BME280_Temp service in the cy_ble_customCServ array */
#define CY_BLE_CUSTOMC_BME280_TEMP_CUSTOM_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Custom Characteristic characteristic */
#define CY_BLE_CUSTOMC_BME280_TEMP_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */

#define CY_BLE_CUSTOMC_BME280_PRESSURE_SERVICE_INDEX   (0x01u) /* Index of BME280_Pressure service in the cy_ble_customCServ array */
#define CY_BLE_CUSTOMC_BME280_PRESSURE_BME280_PRESSURE_CHAR_INDEX   (0x00u) /* Index of BME280_Pressure characteristic */
#define CY_BLE_CUSTOMC_BME280_PRESSURE_BME280_PRESSURE_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */

#define CY_BLE_CUSTOMC_BME280_HUMIDITY_SERVICE_INDEX   (0x02u) /* Index of BME280_Humidity service in the cy_ble_customCServ array */
#define CY_BLE_CUSTOMC_BME280_HUMIDITY_BME280_HUMIDITY_CHAR_INDEX   (0x00u) /* Index of BME280_Humidity characteristic */
#define CY_BLE_CUSTOMC_BME280_HUMIDITY_BME280_HUMIDITY_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */

#define CY_BLE_CUSTOMC_CCS811_TVOC_SERVICE_INDEX   (0x03u) /* Index of CCS811_TVOC service in the cy_ble_customCServ array */
#define CY_BLE_CUSTOMC_CCS811_TVOC_CCS811_TVOC_CHAR_INDEX   (0x00u) /* Index of CCS811_TVOC characteristic */
#define CY_BLE_CUSTOMC_CCS811_TVOC_CCS811_TVOC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */

#define CY_BLE_CUSTOMC_CCS811_ECO2_SERVICE_INDEX   (0x04u) /* Index of CCS811_ECO2 service in the cy_ble_customCServ array */
#define CY_BLE_CUSTOMC_CCS811_ECO2_CCS811_ECO2_CHAR_INDEX   (0x00u) /* Index of CCS811_ECO2 characteristic */
#define CY_BLE_CUSTOMC_CCS811_ECO2_CCS811_ECO2_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */

#define CY_BLE_CUSTOMC_ENVSENSORS_SERVICE_SERVICE_INDEX   (0x05u) /* Index of EnvSensors Service service in the cy_ble_customCServ array */
#define CY_BLE_CUSTOMC_ENVSENSORS_SERVICE_ENVSENORS_CHAR_INDEX   (0x00u) /* Index of EnvSenors characteristic */
#define CY_BLE_CUSTOMC_ENVSENSORS_SERVICE_ENVSENORS_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
