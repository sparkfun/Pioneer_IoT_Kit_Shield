...
{
    Cy_SysClk_PeriphEnableDivider(SPI_SCBCLK_DIV_TYPE, SPI_SCBCLK_DIV_NUM);
}
...
{
    Cy_SysClk_PeriphDisableDivider(SPI_SCBCLK_DIV_TYPE, SPI_SCBCLK_DIV_NUM);
}
...
{
    Cy_SysClk_PeriphSetDivider(SPI_SCBCLK_DIV_TYPE, SPI_SCBCLK_DIV_NUM, dividerValue);
}
...
{
    Cy_SysClk_PeriphSetFracDivider(SPI_SCBCLK_DIV_TYPE, SPI_SCBCLK_DIV_NUM, dividerIntValue, dividerFracValue);
}
